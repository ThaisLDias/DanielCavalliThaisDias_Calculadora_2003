...
namespace Calc
{
    public partial class Form1 : Form
    {
        ...
        private void IteFator(object sender, EventArgs e)
        {
            v2 = v1;
            v1 = calc.FatorialIterativa(v2);
            ab = "";
            Resultado.Text = "Fatorial Iterativa(" + v2 + ")" + " = " + v1;
        }

        private void RecurFator(object sender, EventArgs e)
        {
            v2 = v1;
            v1 = calc.FatorialRecursiva(v2);
            ab = "";
            Resultado.Text = "Fatorial Recursiva(" + v2 + ")" + " = " + v1;
        }

        private void RiboRecur(object sender, EventArgs e)
        {
            v2 = v1;
            v1 = calc.FiboRecursiva(v2);
            ab = "";
            Resultado.Text = "Fibonacci Recursiva(" + v2 + ")" + " = " + v1;
        }


        private void FibonacciIterativa(object sender, EventArgs e)
        {
            v2 = v1;
            v1 = calc.FiboRecursiva(v2);
            ab = "";
            Resultado.Text = "Fibonacci Iterativa(" + v2 + ")" + " = " + v1;
        }
        ...
        {
            Resultado.Text = "Antoanne seu lindo ☆ ◕‿ ◕ ❀ ☼ ☾" + "lpauloboss and Dragonssaur";
        }
